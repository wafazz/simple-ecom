...
| `REQ-005` | ToyyibPay Payment | `app/Http/Controllers/PaymentController.php`<br>`app/Services/ToyyibPayService.php`<br>`app/Models/Payment.php` | `/payment/*` | `tests/Feature/PaymentTest.php` | `docs/documentation.md#payment` | `Built` — Phase 7. **Cannot settle live until OQ-11** |
